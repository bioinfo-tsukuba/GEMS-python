...
use crate::{common_param_type::{self, get_current_absolute_time, overwrtite_global_time_manualy, Task, TaskId, TaskResult}, task_generator::TaskGenerator, task_scheduler::{self, one_machine_schedule_solver}, transition_manager::TransitionManager};
...
pub(crate) struct State {
    pub(crate) transition_function: TransitionManager,
    pub(crate) task_generator: TaskGenerator,
...
impl State {
    pub(crate) fn new(
        transition_function: TransitionManager,
...
/// * `current_state_index` - The current state index of the experiment [`usize`]
...
pub(crate) struct Experiment {
    ...
    pub(crate) shared_variable_history: DataFrame,// mutability is required
